...
第一轮 2020 年以来研究型信源已经加入 [`sources.md`](sources.md) 的 **Recent Research and Reports (2020-present)** 章节。覆盖条令、乌克兰相关智库报告、军事专业文章、网络欺骗综述、AI/ATR 对抗诱饵研究、太空域欺骗和水下声学诱饵。后续更新应优先加深这些簇，而不是继续堆松散新闻。

## 优先补强队列

| 优先级 | 领域 | 当前弱点 | 目标来源 |
|---|---|---|---|
| P0 | 近期 LUCAS / Epic Fury 说法 | 已有官方与专业媒体锚点，但具体诱饵/饱和角色仍需继续证实 | 继续补官方战后细节、采购痕迹、影像分析，或独立国防媒体对 LUCAS 作为诱饵/饱和工具而非单纯一次性攻击机的确认 |
...
| P1 | 胡塞红海诱饵与发射车生存 | 威胁清单和成本交换已有较强锚点；地面诱饵和发射车生存说法仍较间接 | 补 UKMTO、US Navy、CRS/GAO、IISS、RUSI、影像分析，或官方战后资料中的发射车、诱饵、打击效果细节 |
